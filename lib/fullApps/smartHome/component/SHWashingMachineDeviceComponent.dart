          ...
          Row(
            ...
            children: [
              AppButton(
                ...
                color: isStart ? white : SHScaffoldDarkColor,
                child: Row(
                  children: [
                    ...
                    child: Column(
                      children: [
                        Container(
                          padding: EdgeInsets.all(16),
                          decoration: BoxDecoration(
                            color: data.mIsCheck! ? white : SHScaffoldDarkColor,
                          ...
                          child: Image.asset(
                            ...
                            height: 30,
                            width: 30,
                            color: data.mIsCheck! ? black : white,
                          ),
                        ),
                        8.height,
                        Text(data.deviceTitle.validate(), style: primaryTextStyle(color: grey))
                      ],
                    ),
                  ),
                ).onTap(

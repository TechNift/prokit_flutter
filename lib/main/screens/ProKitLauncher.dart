                              ...
                              SingleChildScrollView(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    category(appCat4, app_ic_phone, snapshot.data!.widgets!.name, isNew: true, type: snapshot.data!.widgets!.tag, onTap: () {
                                      ProKitScreenListing(snapshot.data!.widgets).launch(context);
                                    }),
                                    category(appCat1, app_ic_phone, appLblFullApps, isNew: true, type: snapshot.data!.fullApp!.tag, onTap: () {
                                      ProKitScreenListing(snapshot.data!.fullApp).launch(context);
                                    }),
                                    category(appCat2, app_dashboard, appLblDashboard, type: snapshot.data!.dashboard!.tag, onTap: () {
